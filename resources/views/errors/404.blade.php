...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>eVoucher - Prezent | Not Found</title>
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="error error-6 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url(assets/media/error/bg6.jpg);">
				...
				<div class="d-flex flex-column flex-row-fluid text-center">
					<h1 class="error-title font-weight-boldest text-white mb-12" style="margin-top: 12rem;">ERROR #404</h1>
					<p class="display-4 font-weight-bold text-white">Page you are looking for not exist, follow me <a href="{{ route('home') }}" style="color: black">here!</a></p>
				</div>
				<!--end::Content-->
			</div>
			<!--end::Error-->

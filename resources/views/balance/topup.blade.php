...
@section('contentTitle', 'Balance Topup')
@section('content')
...
<div class="main-content__body container-fluid">
  <div class="row justify-content-md-center mt-60">
    <div class="col-md-9">
      <form action="{{ route('balance.topup.process') }}" method="POST" id="add-deposit-form"  enctype="multipart/form-data">
        @csrf
        ...
        <div class="content-area__main">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
							<div class="input-group date" id="topupDate" data-target-input="nearest">
								<input type="text" class="form-control datetimepicker-input" name="deposit_payment_date" data-target="#topupDate" value="" />
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="form-input">
                      ...
                      <input name="deposit_document_number" type="text" class="form-control" id="deposit-document-number" value="">
                    </div>
                </div>
            </div>
            <!-- /.col-md-6 -->
              ...
              <div class="col-md-6">
                  <div class="form-group">
                      <div class="form-input">
                          ...
                          <input name="deposit_receipt_number" type="text" class="form-control" id="receipt-number" value="" required>
                      </div>
                  </div>
              </div>
              <!-- /.col-md-6 -->
                  ...
                  <div class="form-group">
                      <div class="form-input">
                          ...
                          <div class="input-group mb-2">
                              ...
                              <input type="text" name="deposit_amount" class="form-control number-format" id="idr-deposit-amount" required value="">
                          </div>
                      </div>
                  </div>
              </div>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <div class="form-input">
                        ...
                        <textarea name="deposit_description" type="text" class="form-control" id="descriptions" placeholder="" rows="4"></textarea>
                    </div>
                </div>
            </div>
          </div>
          ...
          <div class="form-section clearfix">
            <div class="text-center">
              <button type="submit" class="btn btn-primary btn--width-default border-0 btn-add btn-submit">Add</button>
            </div>
          </div>
        </div>
        <!-- /.content-area__main -->
